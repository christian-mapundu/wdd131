...
const temples = [
	...
	},
	{
		...
		dedicated: "To be Dedicared, 2025",
		area: 18000,
		imageUrl:
		"https://content.churchofjesuschrist.org/templesldsorg/bc/Temples/news-and-events/2020/12/204x170/harare-zimbabwe-temple-rendering.jpg"
	},
	{
		...
		area: 72000,
		imageUrl:
		"https://th.bing.com/th/id/OIP.n-MjaPX9604IJlFHRZl6_gHaE8?w=1800&h=1200&rs=1&pid=ImgDetMain"
	}
...
// newTemplesLink.addEventListener("click", () => {
// 	const filteredTemples = temples.filter(temple => new Date(temple.dedicated).getFullYear() > 2010)
// 	DisplayTemples(filteredTemples);
// 	menuSelection.innerHTML = "Home"
// })
